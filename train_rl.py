"""
Drone RL Lab — Experiment Runner (v2)
======================================
Config-driven training script. Each experiment is defined by a YAML file
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python train_rl.py configs/exp_NNN.yaml")
        print("\nAvailable configs:")
        configs_dir = os.path.join(os.path.dirname(__file__), "configs")
        if os.path.isdir(configs_dir):
            for f in sorted(os.listdir(configs_dir)):
                if f.endswith(".yaml"):
                    print(f"  python train_rl.py configs/{f}")
        sys.exit(1)
